...
class RepetitionCounter(object):
  ...
  def __init__(self, class_name, exercise_dict, enter_threshold=6, exit_threshold=4):
    ...
    # Keeps track of which exercise we are doing
    self._n_exercises = 0
  ...
  def __call__(self, pose_classification):
    ...
    if self._n_repeats == self._reps[self._n_exercises]:
      self._n_repeats = 0
      self._n_exercises += 1
      self._class_name = self._exercises[self._n_exercises % len(self._exercises)]

    print("class name is: " + self._class_name)
    print("repeats is: " + self._n_repeats)
